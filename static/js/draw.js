...
function drawText(doc, textArray, qPerPage, heightQ, width, page){
	...
	for (var i = 0; i<qPerPage; i++){
		...
		var array = doc.splitTextToSize(textArray[qPerPage * page + i], width - 50);
		doc.text(35, heightQ * i + 20, array);
	}
